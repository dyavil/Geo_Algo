...
public:
    ...
    /*! \brief Créer un circulateur sur les sommets autour d'un autre
    ...
    /*! \brief Créer un circulateur sur les faces autour d'un sommet
     * \param v : sommet autour duquel est faite la circulation
     * \return le circulateur de face autour du sommet v
     */
    circulateur_de_faces faces_incidente(Sommet & v);

    /*! \brief Créer un iterateur sur les faces vers un point
    ...
    /*! \brief Initialise un maillage par défaut
     */
    void initEmpty();
    ...
    /*! \brief Met a jour les voisins d'apres une liste d'aretes communes
    ...
    /*! \brief Donne les positions de l'arête commune a 2 triangles
     * \param t1 : triangle 1
     * \param t2 : triangle 2
    ...
    /*! \brief Retourne l'index du triangle contenant le point p
     * \param p : point à tester
     * \return l'index de p1
     */
    int inTriangle(Point p);
